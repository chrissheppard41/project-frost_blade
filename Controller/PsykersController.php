...
/*
	@class PsykersController
	@author Chris Sheppard
	@desc handles the Psykers management section
*/
class PsykersController extends Controller {
...
/**
 * admin_index method
 * ROUTE: /admin/Psykers/index
 * Method: GET
 * Index's all the Psykers
 *
 * @param
 * @return (array)
 */
 ...
 */
	public function admin_delete($options) {
		...
		$this->Flash("You have successfully deleted item(s)", "alert alert-success", array('controller' => 'Psykers', 'action' => 'admin_index', 'admin' => true));
