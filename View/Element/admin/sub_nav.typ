	...
	<li class="dropdown">
		...
		<ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu2">
			...
			<li class="<?php echo $this->Html->Highlight('/^\/admin\/armies/'); ?>">
				<?php echo $this->Html->Url('Armies', array('plugin' => false, 'controller' => 'armies', 'action' => 'index', 'admin' => true), array('class' => 'icon icon-users-alt1')); ?>
			</li>
			<li class="<?php echo $this->Html->Highlight('/^\/admin\/armycharacteristics/'); ?>">
				<?php echo $this->Html->Url('Army characteristics', array('plugin' => false, 'controller' => 'armycharacteristics', 'action' => 'index', 'admin' => true), array('class' => 'icon icon-users-alt1')); ?>
			</li>
		</ul>
	</li>
