...
<div class="users form">
	<div class="page-header">
    	<h1><?php echo $this->Html->Url($this->Html->__t('Squads'), array('controller' => 'Squads', 'action' => 'index', 'admin' => true)); ?> - <?php echo $this->Html->__t('Squad Units'); ?> - <?php echo $this->Html->__t("Admin Edit"); ?></h1>
	</div>
	<?php
	echo $this->Html->Form(array(
		...
		echo $this->Html->Input("Groups", "SquadUnits", array('label' => 'Groups', 'class' => "form-control", 'type' => "select", 'id' => "Groups", "multiple"), $typ__['data']["Groups"]);
